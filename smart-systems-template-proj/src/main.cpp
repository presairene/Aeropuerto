...
=======
	   ...
	   // LOCALIZACIONES 
		...
		//idAvion = dbObject.LeerIdAvion(6);
		//printf("id avion: %d ", idAvion);
...
//_________________________COMIENZO INTELIGENCIA________________________________________
				//1. Pedir valor del sensor localizacion
				//hay_avion = dbObject.LeerSensorLocPISTA();
				//if (hay_avion) {
				//	printf("Hay avion/n");
				//}
				//else {
				//	printf("No hay avion/n");
				//}
				//2.Pedir id avion ¿existe ya este avion?
				/*idAvion = dbObject.LeerIdAvion(6);
				printf("id avion: %d ", idAvion);*/
